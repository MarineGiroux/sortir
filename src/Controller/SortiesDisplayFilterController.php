...
//            $nonInscrit = $form->get('nonInscrit')->getData();
            $inscritOuPas = $form->get('inscritOuPas')->getData();

            $estPassee = $form->get('passeesOuPas')->getData();

            return $this->render('sortie/index.html.twig', [
                'sortie' => $sortieRepository->filterSorties($user, $siteParDefautOuPas, $site, $nomContient, $dateDebut, $dateFin, $estOrganisateur, $inscritOuPas,$estPassee),
                'form' => $form,
            ]);
        }
